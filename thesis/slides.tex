...
\framesubtitle{Dropout Uncertainty Estimation}
	...
	\item We can extract uncertainty from a neural net
	\item Proof by Gal and Ghahramani \cite{gal2016dropout}
	\item We use this proof as theoretical foundation for estimating uncertainty in RDTC
