...
\section{Comparison to State of the Art}\label{sec:results}
...
\begin{figure}[t]
	...
	\caption{The last 5 steps of a extRDTC decision process. The model has used an uncertain attribute and the final classification is wrong. In such a case, a human user could be consulted and manually classify the image.}
