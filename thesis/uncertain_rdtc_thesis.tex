...
\begin{table*}[t]
	...
	\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}} c c c c}
		...
		\hline
		\hline
		ResNet \cite{he2016deep}&       $98.2\pm 0.0$& $85.1\pm 0.6$ & $\mathbf{79.0}\pm 0.2$ \\ 
		\hline 
		...
		\hline
		remRDTC(ours)&          $\mathbf{98.7}$          &          $\mathbf{86.4}$&  $77.7$\\ 
		\hline
		extRDTC(ours)&          $\mathbf{98.7}$          &          $85.4$&  $77.8$\\
		%\hline 
	\end{tabular*}
\end{table*}
...
\begin{table*}[t!]
	...
	\begin{tabular*}{\textwidth}{c  @{\extracolsep{\fill}}c c c c}
		& aRDTC \cite{alaniz2019explainable} & randRDTC & remRDTC & extRDTC \\ 
		%\hline 
		%\hline
		\textbf{CUB}& & & &\\\hline\hline
		Class &  $\mathbf{77.9}$& $76.8$ & $77.7$ & $77.8$ \\ 
		\hline 
		Attribute &  $84.9$&  $83.9$& $\mathbf{87.0}$ & $86.9$ \\ 
		&  &  &  &  \\ 
	\end{tabular*}
\end{table*}
