...
We empirically show that our model (hopefully) reliable yields high uncertainty for ood examples. This would allow the model to consult a human user in cases of high uncertainty, thus making it more applicable in real-world scenarios.
